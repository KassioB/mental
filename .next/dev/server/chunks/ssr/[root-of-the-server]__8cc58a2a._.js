...
;
const metadata = {
    title: "Saúde Mental • Conscientização e Cuidado",
    description: "Informações e recursos sobre saúde mental, autocuidado e bem-estar. Baseado no conteúdo do Hospital Albert Einstein.",
    generator: "v0.app",
    icons: {
        icon: [
            {
